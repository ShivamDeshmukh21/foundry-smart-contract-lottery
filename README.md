...
This project is a Provably Random Raffle which utilizes the power of Chainlink VRF & Chainlink Automation that allows "Players" to participate in a lottery by funding the smart contract with an 'entrace fee' and after a certain interval of time has passed, a winner is picked at random and all the funds are transferred to their account.
...
*[Link to the course](https://www.youtube.com/watch?v=sas02qSFZ74&t=11049s)*
